This is the source for Discover Stories, a cinematic audio story library built with [Next.js](https://nextjs.org).
...
Open [http://localhost:3000](http://localhost:3000) with your browser to see Discover Stories.
